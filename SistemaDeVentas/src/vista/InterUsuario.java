...
public class InterUsuario extends javax.swing.JInternalFrame {
    ...
    public InterUsuario() {
        ...
        txt_ver_password.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        txt_ver_password = new javax.swing.JTextField();
        ...
        getContentPane().add(jtxt_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 170, -1));
        ...
        getContentPane().add(jtxt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 170, -1));
        ...
        txt_ver_password.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(txt_ver_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 170, -1));
    ...
    private void jButton_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_guardarActionPerformed
        if (jtxt_nombre.getText().isEmpty() || jtxt_apellido.getText().isEmpty() || jtxt_usuario.getText().isEmpty() || txt_password.getText().isEmpty() || jtxt_telefono.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Complete todos los Campos");
        } else {
            //validar usuario registrado
            Usuario usuario = new Usuario();
            Ctrl_Usuario controlUsuario = new Ctrl_Usuario();
            if (!controlUsuario.existeUsuario(jtxt_usuario.getText().trim())) {
                usuario.setNombre(jtxt_nombre.getText().trim());
                usuario.setApellido(jtxt_apellido.getText().trim());
                usuario.setUsuario(jtxt_usuario.getText().trim());
                usuario.setPassword(txt_password.getText().trim());
                usuario.setTelefono(jtxt_telefono.getText().trim());
                usuario.setEstado(1);
    ...
    private void jCheckBox_ver_claveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBox_ver_claveMouseClicked
        ...
        if (jCheckBox_ver_clave.isSelected() == true) {
            ...
            txt_ver_password.setText(pass);
            txt_password.setVisible(false);
            txt_ver_password.setVisible(true);
        } else {
            String passwordIngresado = txt_ver_password.getText().trim();
    ...
    private javax.swing.JTextField txt_ver_password;
