...
public class InterCategoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel_wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Fondo4.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_descripcion.getText().isEmpty()) {
            ...
            if (!controlCategoria.existeCategoria(txt_descripcion.getText().trim())) {
                ...
                JOptionPane.showMessageDialog(null, "Categoria existente en la Base de Datos");
            }
        }
        //Limpiar campo
